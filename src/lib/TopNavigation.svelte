<script lang="ts">
    import ShadowDOM from "./ShadowDOM.svelte";
...
<template>
    <ShadowDOM>
        <link rel="stylesheet" href="https://visma-unified-design.s3.eu-north-1.amazonaws.com/latest/dist/css/vud.light-dark.mode.min.css">
      
        <!-- Complex example (three levels, product selection dropdown, user details dropdown) -->
        <header class="navbar navbar-default" id="nc4navTopMain" role="navigation" style="background: #{randomColor};display:block">
            ...
            <nav class="collapse navbar-collapse" aria-label="Menu">
                ...
                <ul class="nav navbar-nav nav-tabs navbar-right first-level context-selector">
                    ...
                    <li class="dropdown user-dropdown pristine icon">
                        <a role="dropdown-toggle button-context button" href={"#"} data-toggle="dropdown">
                            Christian M.
